...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Tremend") |
| group        | string   | Parent company group (e.g. "Tremend") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/peviitor-scrapers/tremendous-software-consulting-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)
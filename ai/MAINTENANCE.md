...
```bash
gh issue list --repo peviitor-scrapers/tremendous-software-consulting-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "Tremend", not the template default

...
4. Verifică prin API că job-urile companiei apar:
   ```bash
   curl -s "https://api.peviitor.ro/v1/scraper/jobs/?cif=18089451&rows=10" | jq
   ```
5. Verifică că `docs/jobs.md` a fost generat și este accesibil:
   - https://peviitor-scrapers.github.io/tremendous-software-consulting-srl-nodejs-scraper/jobs.md

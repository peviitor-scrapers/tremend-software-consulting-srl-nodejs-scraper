...
```bash
gh run view <RUN_ID> --repo peviitor-scrapers/tremend-software-consulting-srl-nodejs-scraper --json status -q .status
```
...
**On every session:**
1. Check open GitHub issues: `gh issue list --repo peviitor-scrapers/tremend-software-consulting-srl-nodejs-scraper --state open`
